                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(onPressed: () async {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Bookssearchviewcomp(result: _searchController.text)));
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) => Container(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    _searchController.value = TextEditingValue(text: suggestions[index]);
                  },
